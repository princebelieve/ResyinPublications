...
const initialForm = { name: "", shortDescription: "", fullDescription: "", category: "", price: "", salePrice: "", distributorPrice: "", distributorMinimumQuantity: 1, currency: "NGN", stock: 0, featured: false, status: "active", brand: "", vendor: "", gtin: "", nafdacNumber: "", googleProductCategory: "", condition: "new", ingredients: "", directions: "", warnings: "", netContent: "", countryOfOrigin: "", coverImage: null, gallery: [] };
...
export default function ProductForm({ onSubmit, editingProduct, onCancelEdit }) {
  ...
  useEffect(() => {
    ...
    setForm({ ...initialForm, ...editingProduct, salePrice: editingProduct.salePrice ?? "", distributorPrice: editingProduct.distributorPrice ?? "", coverImage: null, gallery: [] });
  }, [editingProduct]);
