    ...
    <section className="digital-book-files-panel">
      <div className="digital-book-files-heading">
        <div>
          ...
          <h2>PDF &amp; EPUB files</h2>
          <p>Files are stored in private R2 storage. Buyers receive access only after a paid order is confirmed.</p>
        </div>
      ...
      <form onSubmit={submit} className="digital-book-files-form">
        ...
        <button type="submit" disabled={saving}><Upload size={16} /> {saving ? "Uploading..." : "Upload digital files"}</button>
