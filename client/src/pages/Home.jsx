...
export default function Home() {
  ...
  return <><Navbar /><main className="bookstore-home">
    ...
    <section className="store-author-banner"><div className="store-author-monogram" aria-hidden="true">JE</div><div><span className="store-eyebrow">MEET THE FEATURED AUTHOR</span><h2>Dr. Johnson A. Egonmwan</h2><p>Explore his work and public-interest research.</p><Link to="/author/johnson-egonmwan">Read the author profile</Link></div></section>
    <section className="store-publish"><div><span className="store-eyebrow">MORE VOICES. MORE POSSIBILITIES.</span><h2>Your book could be someone’s next discovery.</h2><p>Submit your book for review and make it available to RESYIN readers.</p></div><Link className="store-secondary" to="/publish-with-us">Publish with us <ArrowRight size={18} /></Link></section>
    </main><Footer /></>;
}
